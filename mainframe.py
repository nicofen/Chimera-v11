...
class Mainframe:
    ...
    async def run(self) -> None:
        ...
        self._tasks = [
            ...
            asyncio.create_task(self.dispatcher.run(),      name="AlertDispatcher"),
            asyncio.create_task(self.alert_agent.run(),         name="AlertAgent"),
            asyncio.create_task(self.regime_classifier.run(), name="RegimeClassifier"),
        ]
